...
import it.epicodeW5E3.beans.Bevanda;
import it.epicodeW5E3.beans.Elemento;
import it.epicodeW5E3.beans.Ordine;
import it.epicodeW5E3.beans.Pizza;
import it.epicodeW5E3.beans.StatoOrdine;
import it.epicodeW5E3.beans.Tavolo;
import it.epicodeW5E3.beans.Topping;
import it.epicodeW5E3.beans.decorators.AnanasDecorator;
import it.epicodeW5E3.beans.decorators.MozzarellaDecorator;
import it.epicodeW5E3.beans.decorators.PomodoroDecorator;
import it.epicodeW5E3.beans.decorators.ProsciuttoDecorator;
import it.epicodeW5E3.beans.decorators.SalameDecorator;


@SpringBootApplication
public class BeWeek5Esercizio3Application {
	
	static AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext();

	public static void main(String[] args) {
		SpringApplication.run(BeWeek5Esercizio3Application.class, args);
		
		ctx.scan("it.epicodeW5E3.beans.");
		ctx.refresh();
...
//		System.out.printf("%n");
		...
		do {
			...
			System.out.println("1 - Pizza Margherita " + "(" + pMargherita.getNome() + ")" + " | Prezzo: €"
					+ (Math.round(pMargherita.getPrezzo() * 100.00)) / 100.00 + " | Calorie: " + pMargherita.getCalorie());
			System.out.println("2 - Pizza Prosciutto " + "(" + pProsciutto.getNome() + ")" + " | Prezzo: €"
					+ (Math.round(pProsciutto.getPrezzo() * 100.00)) / 100.00 + " | Calorie: " + pProsciutto.getCalorie());
			...
			System.out.println("5 - Pizza Salame e prosciutto " + "(" + pSalameProsciutto.getNome() + ")" + " | Prezzo: €"
					+ (Math.round(pSalameProsciutto.getPrezzo() * 100.00)) / 100.00 + " | Calorie: "
...
//			System.out.println(t5);
		...
		Ordine o1 = ctx.getBean(Ordine.class, tavolo, 20, StatoOrdine.IN_CORSO, nPersone, LocalDate.now(), elementi);
		
		// System.out.println(tav1);
		// System.out.println(o1);
		
		// Creazione del conto
		System.out.printf("%nEcco il conto:%n");
		
		System.out.println("----GODFATHER'S PIZZA----");
		o1.getListaOrdine();
		System.out.println("-------------------------");
		System.out.printf("Totale: €%.2f%n", o1.getImportoTotale(elementi));
